  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6 animate-in fade-in duration-500">
      <div className="relative">
        ...
        <div className="w-24 h-24 bg-zinc-100 dark:bg-zinc-900 rounded-full flex items-center justify-center relative border border-zinc-200 dark:border-zinc-800 shadow-xl">
          <Music4 size={40} className="text-purple-600 dark:text-purple-500 opacity-80" />
        </div>
      </div>
      <div className="space-y-2">
        ...
        <h2 className="text-xl font-bold text-zinc-800 dark:text-zinc-200">Trang bạn tìm kiếm không tồn tại</h2>
