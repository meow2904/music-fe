...
export function SidebarPlaylists({ activeId, onSelect }: { activeId: string, onSelect: (id: string) => void }) {
    return (
        <div className="flex flex-col gap-6 py-6 bg-background h-full overflow-y-auto shadow-[4px_0_24px_rgba(0,0,0,0.03)](0,0,0,0.4)] z-10 relative transition-colors">
                    ...
                    <div
                        ...
                        className={cn(
                            ...
                            activeId === playlist.id
                                ? "bg-card shadow-[0_4px_20px_rgba(192,132,252,0.15)](192,132,252,0.1)]"
                    ...
                    >
                        ...
                        <div className="flex flex-col overflow-hidden">
                            <span className={cn(
                                ...
                                activeId === playlist.id ? "text-purple-600" : "text-foreground"
                            )}>
                                {playlist.name}
                            </span>
